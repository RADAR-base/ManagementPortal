...
class StudyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Study entity")
        ...
        .repeat(2) {
            ...
            .post("/api/studies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "studyName":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "studyStatus":null}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_study_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
