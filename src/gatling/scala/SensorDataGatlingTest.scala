...
class SensorDataGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SourceData entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "sourceDataType":"SAMPLE_TEXT", "sourceDataName":"SAMPLE_NAME_TEXT", "processingState":null, "keySchema":"SAMPLE_TEXT", "frequency":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
