...
internal class SubjectResourceIntTest(
    ...
    fun setUp() {
        ...
        restSubjectMockMvc =
            MockMvcBuilders
                .standaloneSetup(subjectResource)
    ...
    fun allSubjects() {
        ...
        restSubjectMockMvc
            .perform(MockMvcRequestBuilders.get("/api/subjects?sort=id,desc"))
    ...
    fun subject() {
        ...
        // Get the subject
        restSubjectMockMvc
            .perform(MockMvcRequestBuilders.get("/api/subjects/{login}", subjectDto!!.login))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
    ...
    fun nonExistingSubject() {
        // Get the subject
        restSubjectMockMvc
            .perform(MockMvcRequestBuilders.get("/api/subjects/{id}", Long.MAX_VALUE))
    ...
    fun deleteSubject() {
        ...
        restSubjectMockMvc
            .perform(
                MockMvcRequestBuilders
                    .delete("/api/subjects/{login}", subjectDto!!.login)
    ...
    fun dynamicSourceRegistrationWithId() {
        ...
        restSubjectMockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/api/subjects/{login}/sources", subjectLogin)
                    .contentType(TestUtil.APPLICATION_JSON_UTF8)
    ...
    fun testDynamicRegistrationAndUpdateSourceAttributes() {
        ...
        val result =
            restSubjectMockMvc
                ...
                .andReturn()
        val value =
            TestUtil.convertJsonStringToObject(
                result.response.contentAsString,
                MinimalSourceDetailsDTO::class.java,
        ...
        restSubjectMockMvc
            .perform(
                MockMvcRequestBuilders
                    .post(
                        "/api/subjects/{login}/sources/{sourceName}",
                        subjectLogin,
                        value.sourceName,
                    ).contentType(TestUtil.APPLICATION_JSON_UTF8)
