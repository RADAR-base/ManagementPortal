...
interface SubjectRepository :
    ...
    RevisionRepository<Subject, Long?, Int>,
    ...
    @Query(
        ...
        countQuery =
            "select distinct count(subject) from Subject subject " +
    ...
    fun findOneWithEagerBySubjectLogin(
    ...
    fun findAllBySubjectLogins(
        @Param("logins") logins: List<String>,
    ): List<Subject>
