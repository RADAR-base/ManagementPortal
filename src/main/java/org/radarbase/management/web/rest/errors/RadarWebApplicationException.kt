 ...
 */
open class RadarWebApplicationException
    @JvmOverloads
    constructor(
        status: HttpStatus,
        reason: String?,
        entityName: String,
        errorCode: String?,
        params: Map<String, String?>? = emptyMap<String, String>(),
         ...
         * @param reason message to client.
         ...
         * body of the request.
         *
         * @param reason    Error message to the client
        ...
        init {
            ...
            paramMap["timestamp"] =
                SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US)
                    .format(Date())
            if (params != null) paramMap.putAll(params)
