...
class DefaultOAuthClientService(
    ...
    override fun findAllOAuthClients(): List<ClientDetails> {
     ...
     */
    override fun findOneByClientId(clientId: String?): ClientDetails {
        return try {
     ...
     */
    override fun updateOauthClient(clientDetailsDto: ClientDetailsDTO): ClientDetails {
     ...
     */
    override fun deleteClientDetails(clientId: String?) {
     ...
     */
    override fun createClientDetail(clientDetailsDto: ClientDetailsDTO): ClientDetails {
    ...
    companion object {
        private val log = LoggerFactory.getLogger(DefaultOAuthClientService::class.java)
    }
}
